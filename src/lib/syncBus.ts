...
export type SyncEvent = 'blocks' | 'ops' | 'trailers' | 'viewdefault' | 'policies' | 'moves' | 'status' | 'dmg' | 'master' | 'visits'
...
const EVENTS: SyncEvent[] = ['blocks', 'ops', 'trailers', 'viewdefault', 'policies', 'moves', 'status', 'dmg', 'master', 'visits']
